// apps/standalone/delete-guard-bus — a tiny module-level request/resolve channel so
// the keyboard router's asset-delete path (which runs outside the React tree,
// in main.tsx DI) can surface a UI-layer confirmation dialog (T4-3 / AC-C2)
// without the editor-core staying headless. The router deps call
// requestDeleteGuard(...); a mounted <DeleteGuardDialog/> resolves it.
//
// Anchors:
