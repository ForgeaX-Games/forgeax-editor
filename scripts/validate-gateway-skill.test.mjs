...
// Round-2/3/4 anchors — this fixture must carry every REQUIRED_KEYWORDS entry
  ...
  'Wait on gateway.waitOperationRun(requestId) and inspect the terminal OperationRun for a scene mount.',
  'Read the run with gateway.getOperationRun(requestId) before or after waiting.',
