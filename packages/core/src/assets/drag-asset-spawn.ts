...
export function buildSpawnEntityFromDragRef(ref: DragAssetRef): SpawnRefEntity | null {
  ...
  //
  // Imported default bindings live on the MeshAsset itself. An empty
  // MeshRenderer override list therefore means "inherit every mesh slot" and
  // is the only correct spawn shape for an imported mesh.
