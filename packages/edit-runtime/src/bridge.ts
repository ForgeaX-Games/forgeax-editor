...
import { createHierarchyPanelContributionsExtension } from '@forgeax/editor-panels';
...
export { createHierarchyPanelContributionsExtension } from '@forgeax/editor-panels';
